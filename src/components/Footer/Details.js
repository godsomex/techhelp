...
function Details() {
    return (
        <div className="details">
            <div>
                <h4 className="h4-title h4-margin-title">ABOUT US</h4>
                <ul>
            ...
            <div>
            <h4 className="h4-title h4-margin-title">OUR SERVICES</h4>
                <ul>
            ...
            <div>
            <h4 className="h4-title h4-margin-title">PRESS</h4>
                <ul>
            ...
            <div className="newsletter">
                <h4 className="h4-title h4-margin-title">Join Our Newsletter</h4>
